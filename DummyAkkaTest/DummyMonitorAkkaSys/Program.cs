...
namespace DummyMonitorAkkaSys
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var actor = actorSystem.ActorOf(actorSystem.DI().Props<MonitorActor>(), nameof(MonitorActor));
            var coinActor = actorSystem.ActorSelection($"akka.tcp://{Configure.TargetSysName}@127.0.0.1:{Configure.TargetSysPort}/user/{Configure.TargetSysCoinActor}");
